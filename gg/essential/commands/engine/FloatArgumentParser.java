...
@Metadata(mv = { 1, 6, 0 }, k = 1, xi = 48, d1 = { """
                                                   ...
                                                   """ }, d2 = { "Lgg/essential/commands/engine/FloatArgumentParser;", "Lgg/essential/api/commands/ArgumentParser;", "", "()V", "parse", "arguments", "Lgg/essential/api/commands/ArgumentQueue;", "param", "Ljava/lang/reflect/Parameter;", "(Lgg/essential/api/commands/ArgumentQueue;Ljava/lang/reflect/Parameter;)Ljava/lang/Float;", "essential" })
public final class FloatArgumentParser implements ArgumentParser<Float>
{
    ...
    @NotNull
    @Override
    public Float parse(@NotNull final ArgumentQueue arguments, @NotNull final Parameter param) {
