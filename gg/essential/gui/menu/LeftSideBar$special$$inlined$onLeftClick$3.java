...
public static final class LeftSideBar$special$$inlined$onLeftClick$3 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ LeftSideBar this$0;
    
    public LeftSideBar$special$$inlined$onLeftClick$3(final LeftSideBar this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            LeftSideBar.access$getWardrobeButton(this.this$0).runAction();
        }
    }
