...
static final class LeftSideBar$isSale$1 extends Lambda implements Function1<Sale, Boolean> {
    public static final LeftSideBar$isSale$1 INSTANCE;
    
    LeftSideBar$isSale$1() {
        super(1);
    }
    ...
    static {
        LeftSideBar$isSale$1.INSTANCE = new LeftSideBar$isSale$1();
    }
}