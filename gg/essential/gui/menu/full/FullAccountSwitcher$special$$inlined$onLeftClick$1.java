...
public static final class FullAccountSwitcher$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ FullAccountSwitcher this$0;
    
    public FullAccountSwitcher$special$$inlined$onLeftClick$1(final FullAccountSwitcher this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            if (!this.this$0.hasFocus()) {
                ...
                this.this$0.releaseWindowFocus();
            }
            it2.stopPropagation();
        }
    }
