...
static final class FullAccountSwitcher$2 extends Lambda implements Function1<Session, String> {
    public static final FullAccountSwitcher$2 INSTANCE;
    
    FullAccountSwitcher$2() {
        super(1);
    }
    ...
    static {
        INSTANCE = new Function1<Session, String>() {
            public static final FullAccountSwitcher$2 INSTANCE;
