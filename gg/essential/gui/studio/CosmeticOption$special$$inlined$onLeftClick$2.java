...
public static final class CosmeticOption$special$$inlined$onLeftClick$2 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ CosmeticOption this$0;
    
    public CosmeticOption$special$$inlined$onLeftClick$2(final CosmeticOption this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            this.this$0.getEditingPlacement().set(true);
        }
    }
