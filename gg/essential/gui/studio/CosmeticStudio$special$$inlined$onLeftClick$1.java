...
public static final class CosmeticStudio$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ CosmeticStudio this$0;
    
    public CosmeticStudio$special$$inlined$onLeftClick$1(final CosmeticStudio this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            this.this$0.getSelectedCategory().set(Category.Cart.INSTANCE);
        }
    }
