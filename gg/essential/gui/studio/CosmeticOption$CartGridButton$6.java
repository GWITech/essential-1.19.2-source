...
static final class CosmeticOption$CartGridButton$6 extends Lambda implements Function1<Boolean, Color> {
    public static final CosmeticOption$CartGridButton$6 INSTANCE;
    
    CosmeticOption$CartGridButton$6() {
        super(1);
    }
