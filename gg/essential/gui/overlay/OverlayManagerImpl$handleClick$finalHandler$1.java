...
static final class OverlayManagerImpl$handleClick$finalHandler$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ Ref$BooleanRef $consumed;
    
    OverlayManagerImpl$handleClick$finalHandler$1(final Ref$BooleanRef $consumed) {
        this.$consumed = $consumed;
        super(2);
    }
    
    public final void invoke(@NotNull final UIComponent $this$null, @NotNull final UIClickEvent it) {
