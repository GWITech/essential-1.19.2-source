...
public static final class FocusComponent$special$$inlined$onLeftClick$3 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ FocusComponent this$0;
    
    public FocusComponent$special$$inlined$onLeftClick$3(final FocusComponent this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            FocusComponent.access$getScreenshotBrowser$p(this.this$0).openEditor();
        }
    }
