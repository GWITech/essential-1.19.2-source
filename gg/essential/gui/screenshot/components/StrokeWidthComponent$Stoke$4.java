...
static final class StrokeWidthComponent$Stoke$4 extends Lambda implements Function1<Pair<? extends Boolean, ? extends Boolean>, Color> {
    public static final StrokeWidthComponent$Stoke$4 INSTANCE;
    
    StrokeWidthComponent$Stoke$4() {
        super(1);
    }
    ...
    public final Color invoke(@NotNull final Pair<Boolean, Boolean> pair) {
        ...
        return selected ? EssentialPalette.TEXT_HIGHLIGHT : (hovered ? EssentialPalette.TEXT : EssentialPalette.BUTTON_HIGHLIGHT);
    }
