...
static final class ScreenshotScrollComponent$3 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ ScreenshotScrollComponent this$0;
    
    ScreenshotScrollComponent$3(final ScreenshotScrollComponent $receiver) {
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent event) {
        ...
        ScreenshotScrollComponent.access$onClick(this.this$0, event.getRelativeX(), event.getRelativeY(), event.getMouseButton());
    }
