...
public static final class StrokeWidthComponent$Stoke$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ StrokeWidthComponent this$0;
    final /* synthetic */ Stoke this$1$inlined;
    
    public StrokeWidthComponent$Stoke$special$$inlined$onLeftClick$1(final StrokeWidthComponent this$0, final Stoke this$1$inlined) {
        this.this$0 = this$0;
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            StrokeWidthComponent.access$getSelectedWidth$p(this.this$0).set(this.this$1$inlined.getWidth());
        }
    }
