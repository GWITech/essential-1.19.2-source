...
public static final class ScreenshotColorPicker$createMouseDragListener$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            ScreenshotColorPicker.access$createMouseDragListener$updateState(this.$component$inlined, this.$basicState$inlined, it2.getRelativeX(), it2.getRelativeY());
        }
    }
