...
static final class ScreenshotScrollComponent$setScrollBarComponent$2 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ boolean $isHorizontal;
    final /* synthetic */ ScreenshotScrollComponent this$0;
    
    ScreenshotScrollComponent$setScrollBarComponent$2(final ScreenshotScrollComponent $receiver) {
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent event) {
        ...
        ScreenshotScrollComponent.access$setVerticalDragBeginPos$p(this.this$0, event.getRelativeY());
    }
