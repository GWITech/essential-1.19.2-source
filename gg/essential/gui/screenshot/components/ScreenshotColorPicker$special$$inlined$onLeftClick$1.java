...
public static final class ScreenshotColorPicker$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ ScreenshotColorPicker this$0;
    
    public ScreenshotColorPicker$special$$inlined$onLeftClick$1(final ScreenshotColorPicker this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ScreenshotColorPicker.access$getShowMenu$p(this.this$0).set((Function1)ScreenshotColorPicker$collapsedBlock$3$1.INSTANCE);
        }
    }
