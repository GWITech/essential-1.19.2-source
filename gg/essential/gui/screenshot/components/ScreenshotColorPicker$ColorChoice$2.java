...
static final class ScreenshotColorPicker$ColorChoice$2 extends Lambda implements Function1<Pair<? extends Boolean, ? extends Boolean>, Color> {
    public static final ScreenshotColorPicker$ColorChoice$2 INSTANCE;
    
    ScreenshotColorPicker$ColorChoice$2() {
        super(1);
    }
    ...
    public final Color invoke(@NotNull final Pair<Boolean, Boolean> pair) {
        ...
        return active ? EssentialPalette.TEXT_HIGHLIGHT : (hovered ? EssentialPalette.GRAY_OUTLINE : EssentialPalette.COMPONENT_BACKGROUND);
    }
