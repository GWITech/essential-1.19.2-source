...
static final class ScreenshotColorPicker$1 extends Lambda implements Function1<Pair<? extends Float, ? extends Float>, Unit> {
    final /* synthetic */ ScreenshotColorPicker this$0;
    
    ScreenshotColorPicker$1(final ScreenshotColorPicker $receiver) {
    ...
    public final void invoke(@NotNull final Pair<Float, Float> pair) {
        ...
        ScreenshotColorPicker.access$getHue$p(this.this$0).set(yPercent);
    }
