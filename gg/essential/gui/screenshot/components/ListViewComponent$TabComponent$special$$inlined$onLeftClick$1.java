...
public static final class ListViewComponent$TabComponent$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ ListViewComponent this$0;
    final /* synthetic */ TabComponent this$1$inlined;
    
    public ListViewComponent$TabComponent$special$$inlined$onLeftClick$1(final ListViewComponent this$0, final TabComponent this$1$inlined) {
        this.this$0 = this$0;
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            ListViewComponent.access$getSelectedTab$p(this.this$0).set(this.this$1$inlined.getTab());
        }
    }
