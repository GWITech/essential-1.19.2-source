...
static final class ScreenshotColorPicker$2 extends Lambda implements Function1<Pair<? extends Float, ? extends Float>, Unit> {
    final /* synthetic */ ScreenshotColorPicker this$0;
    
    ScreenshotColorPicker$2(final ScreenshotColorPicker $receiver) {
    ...
    public final void invoke(@NotNull final Pair<Float, Float> pair) {
        ...
        ScreenshotColorPicker.access$getAlpha$p(this.this$0).set(xPercent);
    }
