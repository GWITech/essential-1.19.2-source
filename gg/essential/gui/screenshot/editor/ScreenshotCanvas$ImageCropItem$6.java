...
static final class ScreenshotCanvas$ImageCropItem$6 extends Lambda implements Function1<UIComponent, Unit> {
    public static final ScreenshotCanvas$ImageCropItem$6 INSTANCE;
    
    ScreenshotCanvas$ImageCropItem$6() {
        super(1);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseLeave) {
        ...
        final Iterable $this$forEach$iv = $this$onMouseLeave.getChildren();
        for (final Object element$iv : $this$forEach$iv) {
            final UIComponent it = (UIComponent)element$iv;
            ExtensionsKt.animateColor$default$7bfe46b2$7cb552a(it, EssentialPalette.TEXT);
        }
    }
