...
public static final class ScopeExpansionWindowProvider$combine$$inlined$sortedBy$1<T> implements Comparator {
    public ScopeExpansionWindowProvider$combine$$inlined$sortedBy$1() {
        super();
    }
    ...
    public final int compare(final T a, final T b) {
        ...
        // Original Bytecode:
        // 
        //     1: checkcast       Lkotlin/ranges/IntRange;
        //     4: astore_3        /* it */
        //     5: aload_3         /* it */
        //     6: invokevirtual   kotlin/ranges/IntRange.getFirst:()I
        //     9: invokestatic    java/lang/Integer.valueOf:(I)Ljava/lang/Integer;
        //    12: checkcast       Ljava/lang/Comparable;
        //    15: aload_2         /* b */
        //    16: checkcast       Lkotlin/ranges/IntRange;
        //    19: astore_3       
        //    20: astore          4
        //    22: aload_3         /* it */
        //    23: invokevirtual   kotlin/ranges/IntRange.getFirst:()I
