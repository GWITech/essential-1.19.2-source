...
public static final class ImageEmbedImpl$FocusedView$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ ImageEmbedImpl this$0;
    
    public ImageEmbedImpl$FocusedView$special$$inlined$onLeftClick$1(final ImageEmbedImpl this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            final URI uri = this.this$0.getUrl().toURI();
            Intrinsics.checkNotNullExpressionValue((Object)uri, "url.toURI()");
