...
static final class FriendsTab$populate$1 extends Lambda implements Function1<UUID, UIComponent> {
    final /* synthetic */ FriendsTab this$0;
    
    FriendsTab$populate$1(final FriendsTab $receiver) {
    ...
    public final UIComponent invoke(@NotNull final UUID it) {
        ...
        return (UIComponent)new FriendUserEntry(this.this$0.getGui(), it, (SortListener)FriendsTab.access$getFriendSection(this.this$0));
    }
