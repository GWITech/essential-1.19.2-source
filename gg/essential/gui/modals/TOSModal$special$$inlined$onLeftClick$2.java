...
public static final class TOSModal$special$$inlined$onLeftClick$2 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    public TOSModal$special$$inlined$onLeftClick$2() {
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            final UIComponent $this$tosConfirmContainer_delegate_u24lambda_u2d6 = $this$findChildOfTypeOrNull_u24default$iv = $this$onMouseClick;
