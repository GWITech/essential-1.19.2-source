...
public static final class TOSModal$special$$inlined$onLeftClick$4 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    public TOSModal$special$$inlined$onLeftClick$4() {
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            GuiUtil.INSTANCE.pushModal(new OpenLinkModal(new URI("https://essential.gg/privacy-policy")));
            it2.stopPropagation();
        }
    }
