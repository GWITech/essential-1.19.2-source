...
static final class NoticeFlag$hasTop$1 extends Lambda implements Function1<MenuButton.Style, Boolean> {
    public static final NoticeFlag$hasTop$1 INSTANCE;
    ...
    public final Boolean invoke(@NotNull final MenuButton.Style it) {
        ...
        return it.getSides().contains(OutlineEffect.Side.Top);
    }
    ...
    static {
        NoticeFlag$hasTop$1.INSTANCE = new NoticeFlag$hasTop$1();
    }
}