...
static final class NoticeFlag$hasLeft$1 extends Lambda implements Function1<MenuButton.Style, Boolean> {
    public static final NoticeFlag$hasLeft$1 INSTANCE;
    
    NoticeFlag$hasLeft$1() {
        super(1);
    }
    ...
    static {
        NoticeFlag$hasLeft$1.INSTANCE = new NoticeFlag$hasLeft$1();
    }
}