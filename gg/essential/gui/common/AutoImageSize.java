...
public final class AutoImageSize implements CacheableImage
{
    ...
    public AutoImageSize(@NotNull final UIComponent component, final byte b) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        super();
        this.component = component;
        this.alwaysOverrideSize = false;
    }
    
    public AutoImageSize(final UIComponent component) {
    ...
    public void applyTexture(@Nullable final ReleasedDynamicTexture texture) {
        ...
        if (this.appearsDefaultOrOverridable(constraints.getWidth()) && this.appearsDefaultOrOverridable(constraints.getHeight())) {
            final UIComponent $this$constrain_u24lambda_u2d0$iv;
            final UIComponent $this$constrain$iv = $this$constrain_u24lambda_u2d0$iv = this.component;
    ...
    public static final class AutomaticImageSizeConstraint implements HeightConstraint, WidthConstraint
    {
