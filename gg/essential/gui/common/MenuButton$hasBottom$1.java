...
static final class MenuButton$hasBottom$1 extends Lambda implements Function1<Style, Boolean> {
    public static final MenuButton$hasBottom$1 INSTANCE;
    
    MenuButton$hasBottom$1() {
        super(1);
    }
    ...
    static {
        MenuButton$hasBottom$1.INSTANCE = new MenuButton$hasBottom$1();
    }
}