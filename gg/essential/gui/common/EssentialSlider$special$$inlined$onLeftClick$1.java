...
public static final class EssentialSlider$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ BasicState $mouseHeld$inlined;
    final /* synthetic */ EssentialSlider this$0;
    
    public EssentialSlider$special$$inlined$onLeftClick$1(final BasicState $mouseHeld$inlined, final EssentialSlider this$0) {
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            this.$mouseHeld$inlined.set(true);
            EssentialSlider.access$updateSlider(this.this$0, it2.getAbsoluteX() - this.this$0.getLeft());
            it2.stopPropagation();
        }
    }
