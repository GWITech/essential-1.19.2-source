...
public static final class HighlightedBlock$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ HighlightedBlock this$0;
    
    public HighlightedBlock$special$$inlined$onLeftClick$1(final HighlightedBlock this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            this.this$0.getClickAction().invoke((Object)it2);
            this.this$0.setClicked(true);
            if (this.this$0.getClickBehavior() == ClickBehavior.UNHIGHLIGHT) {
                this.this$0.unhighlight();
            }
        }
    }
