...
static final class StateExtensionsKt$bindParent$1 extends Lambda implements Function1<Boolean, UIComponent> {
    final /* synthetic */ UIComponent $parent;
    
    StateExtensionsKt$bindParent$1(final UIComponent $parent) {
        this.$parent = $parent;
        super(1);
    }
