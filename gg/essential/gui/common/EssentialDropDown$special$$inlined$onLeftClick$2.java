...
public static final class EssentialDropDown$special$$inlined$onLeftClick$2 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ EssentialDropDown this$0;
    
    public EssentialDropDown$special$$inlined$onLeftClick$2(final EssentialDropDown this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            if (EssentialDropDown.access$getWritableExpandedState$p(this.this$0).get()) {
                EssentialDropDown.collapse$default$9b419f8$5d69b91c(this.this$0);
            }
            else {
                EssentialDropDown.expand$default$9b419f8$5d69b91c(this.this$0);
            }
        }
    }
