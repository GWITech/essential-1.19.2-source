...
static final class AbstractTextInput$1 extends Lambda implements Function3<UIComponent, Character, Integer, Unit> {
    ...
    public final void invoke(@NotNull final UIComponent $this$onKeyType, final char typedChar, final int keyCode) {
        ...
        if (keyCode == UKeyboard.KEY_ESCAPE) {
        ...
        else if (SharedConstants.isValidChar(typedChar)) {
            ...
            this.this$0.setCursorNeedsRefocus$1385ff();
        }
            ...
            if (UKeyboard.isShiftKeyDown()) {
                this$0.setCursor(it);
                this$0.setCursorNeedsRefocus$1385ff();
            }
            else {
            ...
            final Pair<Float, Float> screenPos3 = this.this$0.getCursor().toScreenPos();
            final float posX = ((Number)screenPos3.component1()).floatValue();
            final float posY = ((Number)screenPos3.component2()).floatValue();
            AbstractTextInput.access$showOptionMenu(this.this$0, $this$onKeyType.getLeft() + posX, $this$onKeyType.getTop() + posY);
        }
    }
