...
@Metadata(mv = { 1, 6, 0 }, k = 1, xi = 48, d1 = { """
                                                   ...
                                                   \u0002\b\u0004
                                                   \u0002\u0018\u0002\u0018\u0000 \u00052\u00020\u0001:\u0001\u0005B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004¨\u0006\u0006²\u0006
                                                   \u0010\u0007\u001a\u00020\bX\u008a\u0084\u0002""" }, d2 = { "Lgg/essential/gui/common/modal/OpenLinkModal;", "Lgg/essential/gui/common/modal/ConfirmDenyModal;", "uri", "Ljava/net/URI;", "(Ljava/net/URI;)V", "Companion", "essential", "domain", "Lgg/essential/elementa/UIComponent;" })
public final class OpenLinkModal extends ConfirmDenyModal
{
    ...
    public OpenLinkModal(@NotNull final URI uri) {
        ...
        final OpenLinkModal $this$_init__u24lambda_u2d0 = (OpenLinkModal)$this$configure_u24lambda_u2d0$iv;
        $this$_init__u24lambda_u2d0.setTitleText("You are about to visit: ");
        $this$_init__u24lambda_u2d0.setPrimaryButtonText("Open Browser");
        this.getSpacer().setHeight(UtilitiesKt.getPixels(17)).setY(new SiblingConstraint(0.0f, false, 3, null));
        this.configureLayout((Function1<? super UIContainer, Unit>)new OpenLinkModal.OpenLinkModal$2(uri, this));
        this.onPrimaryAction((Function0<Unit>)new OpenLinkModal.OpenLinkModal$3(uri));
    }
