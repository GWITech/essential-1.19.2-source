...
public static final class UserSelectionModal$Searchbar$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ Searchbar this$0;
    
    public UserSelectionModal$Searchbar$special$$inlined$onLeftClick$1(final Searchbar this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            UserSelectionModal.Searchbar.access$getSearchInput(this.this$0).grabWindowFocus();
        }
    }
