...
@Metadata(mv = { 1, 6, 0 }, k = 1, xi = 48, d1 = { """
                                                   ...
                                                   \u0002\u0010 
                                                   \u0002\u0018\u0002
                                                   \u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001:\u0001\rB\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0016\u0010\b\u001a\u00020	2\f\u0010
                                                   \u001a\b\u0012\u0004\u0012\u00020\f0\u000bH\u0002R\u0016\u0010\u0005\u001a
                                                   \u0012\u0006\u0012\u0004\u0018\u00010\u00070\u0006X\u0082\u0004¢\u0006\u0002
                                                   \u0000¨\u0006\u000e""" }, d2 = { "Lgg/essential/gui/sps/WorldSelectionModal;", "Lgg/essential/gui/common/modal/SearchableConfirmDenyModal;", "fadeTime", "", "(F)V", "selectedWorld", "Lgg/essential/elementa/state/State;", "Lgg/essential/gui/sps/WorldSelectionModal$WorldEntry;", "populate", "", "worldList", "", "Lnet/minecraft/world/level/storage/LevelSummary;", "WorldEntry", "essential" })
public final class WorldSelectionModal extends SearchableConfirmDenyModal
{
    @NotNull
    private final State<WorldEntry> selectedWorld;
    
    public WorldSelectionModal(final float fadeTime) {
        super(fadeTime);
        this.selectedWorld = new BasicState<WorldEntry>(null);
        this.setTitleText("Select World");
        this.setPrimaryButtonText("Next");
        this.getScroller().setEmptyText("No worlds found.");
        this.getPrimaryActionButton().rebindEnabled((State<Boolean>)this.selectedWorld.map((kotlin.jvm.functions.Function1<? super WorldEntry, ?>)WorldSelectionModal$1.INSTANCE));
        this.hideSearchbar();
        final List<? extends LevelSummary> value = UMinecraft.getMinecraft().getLevelStorage().loadSummaries(UMinecraft.getMinecraft().getLevelStorage().getLevelList()).get();
        Intrinsics.checkNotNullExpressionValue((Object)value, "getMinecraft().levelStor\u2026lStorage.levelList).get()");
        this.populate(value);
        StateExtensionsKt.onSetValueAndNow((State<Object>)this.getSearchbar().getTextContent(), (kotlin.jvm.functions.Function1<? super Object, Unit>)new Function1<String, Unit>() {
            final /* synthetic */ WorldSelectionModal this$0;
            
            WorldSelectionModal$2() {
        ...
        final State<WorldEntry> selectedWorld = this.selectedWorld;
        final UIComponent this_$iv = this.getScroller();
        selectedWorld.set((WorldEntry)CollectionsKt.firstOrNull((List)this_$iv.childrenOfType(WorldEntry.class)));
        this.onPrimaryAction((Function0<Unit>)new Function0<Unit>() {
            final /* synthetic */ WorldSelectionModal this$0;
            
            WorldSelectionModal$3() {
                this.this$0 = $receiver;
                super(0);
            }
    ...
    public WorldSelectionModal(final byte b) {
        this(0.5f);
    }
    
    private final void populate(final List<? extends LevelSummary> worldList) {
        for (final LevelSummary worldSummary : worldList) {
            this.showSearchbar();
            final UIComponent $this$onLeftClick$iv = new WorldEntry(this.selectedWorld, worldSummary);
            ...
            }), this.getScroller(), this.getSearchbar().getTextContent().map((kotlin.jvm.functions.Function1<? super Object, ?>)new WorldSelectionModal$populate.WorldSelectionModal$populate$2(worldSummary)), false, null, 12);
        }
    }
    
    public WorldSelectionModal() {
        this((byte)0);
    }
    
    public static final /* synthetic */ State access$getSelectedWorld$p(final WorldSelectionModal $this) {
