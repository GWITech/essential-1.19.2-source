...
public static final class RightPane$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ RightPane this$0;
    
    public RightPane$special$$inlined$onLeftClick$1(final RightPane this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            RightPane.access$getScroller(this.this$0).scrollToTop(true);
        }
    }
