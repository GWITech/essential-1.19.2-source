...
static final class LeftPane$MenuItem$color$1 extends Lambda implements Function1<Pair<? extends Boolean, ? extends Boolean>, Color> {
    public static final LeftPane$MenuItem$color$1 INSTANCE;
    
    LeftPane$MenuItem$color$1() {
        super(1);
    }
    ...
    static {
        LeftPane$MenuItem$color$1.INSTANCE = new LeftPane$MenuItem$color$1();
    }
}