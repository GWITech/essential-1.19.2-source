...
public static final class TopMenu$_init_$lambda-9$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ Map.Entry $menuItem$inlined;
    
    public TopMenu$_init_$lambda-9$$inlined$onLeftClick$1(final Map.Entry $menuItem$inlined) {
        this.$menuItem$inlined = $menuItem$inlined;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            ...
            OpenLinkModal.Companion.openUrl(new URI(this.$menuItem$inlined.getValue()));
        }
    }
