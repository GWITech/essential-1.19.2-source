...
static final class AnimationFile$Companion$json$1 extends Lambda implements Function1<JsonBuilder, Unit> {
    public static final AnimationFile$Companion$json$1 INSTANCE;
    
    AnimationFile$Companion$json$1() {
        super(1);
    }
    ...
    static {
        AnimationFile$Companion$json$1.INSTANCE = new AnimationFile$Companion$json$1();
    }
}