...
public final class MulExpr implements MolangExpression
{
    ...
    public MulExpr(@NotNull final MolangExpression left, @NotNull final MolangExpression right) {
    ...
    public boolean equals(@Nullable final Object other) {
        ...
        if (!(other instanceof MulExpr)) {
            return false;
        }
        final MulExpr mulExpr = (MulExpr)other;
        return Intrinsics.areEqual((Object)this.left, (Object)mulExpr.left) && Intrinsics.areEqual((Object)this.right, (Object)mulExpr.right);
    }
}
