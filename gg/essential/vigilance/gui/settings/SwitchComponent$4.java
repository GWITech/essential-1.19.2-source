...
static final class SwitchComponent$4 extends Lambda implements Function1<UIComponent, Unit> {
    final /* synthetic */ SwitchComponent this$0;
    
    SwitchComponent$4(final SwitchComponent $receiver) {
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseLeave) {
        ...
        final int n2 = 0;
        AnimatingConstraints.setColorAnimation$default($this$invoke_u24lambda_u2d0, Animations.OUT_EXP, 0.25f, ExtensionsKt.toConstraint(VigilancePalette.INSTANCE.getComponentBackground$Vigilance()), 0.0f, 8, null);
