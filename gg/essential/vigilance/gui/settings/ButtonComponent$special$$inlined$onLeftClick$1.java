...
public static final class ButtonComponent$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ ButtonComponent this$0;
    
    public ButtonComponent$special$$inlined$onLeftClick$1(final ButtonComponent this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            final UIComponent $this$_init__u24lambda_u2d4 = $this$onMouseClick;
            final int n = 0;
