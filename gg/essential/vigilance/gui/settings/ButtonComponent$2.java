...
static final class ButtonComponent$2 extends Lambda implements Function1<UIComponent, Unit> {
    final /* synthetic */ ButtonComponent this$0;
    
    ButtonComponent$2(final ButtonComponent $receiver) {
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseEnter) {
        ...
        final int n2 = 0;
        AnimatingConstraints.setColorAnimation$default($this$invoke_u24lambda_u2d0, Animations.OUT_EXP, 0.5f, ExtensionsKt.toConstraint(VigilancePalette.INSTANCE.getButtonHighlight$Vigilance()), 0.0f, 8, null);
