...
public final class ShadowIcon extends UIContainer
{
    ...
    public ShadowIcon(@NotNull final State<ImageFactory> imageFactory, @NotNull final State<Boolean> buttonShadow, @NotNull final State<Color> primaryColor, @NotNull final State<Color> shadowColor) {
        ...
        gg.essential.vigilance.utils.ExtensionsKt.onSetValueAndNow(this.iconState.zip((State<Object>)this.buttonShadowState), (kotlin.jvm.functions.Function1<? super kotlin.Pair<Object, Object>, Unit>)new Function1<Pair<? extends ImageFactory, ? extends Boolean>, Unit>() {
    ...
    public ShadowIcon(@NotNull final ImageFactory imageFactory, final boolean buttonShadow) {
        Intrinsics.checkNotNullParameter((Object)imageFactory, "imageFactory");
        this(new BasicState<ImageFactory>(imageFactory), new BasicState<Boolean>(buttonShadow));
    }
    ...
    public ShadowIcon(@NotNull final State<ImageFactory> imageFactory, @NotNull final State<Boolean> buttonShadow) {
        ...
        this(imageFactory, buttonShadow, new BasicState<Color>(black), VigilancePalette.INSTANCE.getTextShadow$Vigilance());
        this.rebindPrimaryColor(VigilancePalette.INSTANCE.getTextColor$Vigilance(gg.essential.vigilance.utils.ExtensionsKt.hoveredState$default(this, false, false, 3, null)));
    }
    ...
    @NotNull
    public final ShadowIcon rebindShadow(@NotNull final State<Boolean> shadow) {
        Intrinsics.checkNotNullParameter((Object)shadow, "shadow");
        final ShadowIcon $this$rebindShadow_u24lambda_u2d3 = this;
        final int n = 0;
        $this$rebindShadow_u24lambda_u2d3.buttonShadowState.rebind(shadow);
        return this;
    }
