...
static final class Tooltip$bindLine$2 extends Lambda implements Function1<String, Unit> {
    ...
    Tooltip$bindLine$2(final Tooltip $receiver, final Function1<? super UIText, Unit> $configure) {
    ...
    public final void invoke(@NotNull final String it) {
        ...
        this.this$0.addLine(it, (Function1<? super UIText, Unit>)this.$configure);
    }
