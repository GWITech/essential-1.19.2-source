...
static final class AbstractTextInput$4 extends Lambda implements Function4<UIComponent, Float, Float, Integer, Unit> {
    final /* synthetic */ AbstractTextInput this$0;
    
    AbstractTextInput$4(final AbstractTextInput $receiver) {
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseDrag, final float mouseX, final float mouseY, final int mouseButton) {
        ...
        switch (AbstractTextInput$4.WhenMappings.$EnumSwitchMapping$0[this.this$0.getSelectionMode().ordinal()]) {
            case 1: {
