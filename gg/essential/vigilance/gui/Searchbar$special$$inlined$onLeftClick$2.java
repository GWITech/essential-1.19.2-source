...
public static final class Searchbar$special$$inlined$onLeftClick$2 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ Searchbar this$0;
    
    public Searchbar$special$$inlined$onLeftClick$2(final Searchbar this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            final UIComponent $this$_init__u24lambda_u2d6 = $this$onMouseClick;
            final int n = 0;
