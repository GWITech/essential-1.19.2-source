...
public static final class SettingsGui$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ SettingsGui this$0;
    
    public SettingsGui$special$$inlined$onLeftClick$1(final SettingsGui this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            final UIComponent $this$_init__u24lambda_u2d14 = $this$onMouseClick;
            final int n = 0;
            SettingsCategory.closePopups$default(SettingsGui.access$getCurrentCategory$p(this.this$0), false, 1, null);
        }
    }
