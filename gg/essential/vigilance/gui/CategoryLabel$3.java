...
static final class CategoryLabel$3 extends Lambda implements Function1<UIComponent, Unit> {
    final /* synthetic */ CategoryLabel this$0;
    
    CategoryLabel$3(final CategoryLabel $receiver) {
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseEnter) {
        ...
        if (!this.this$0.isSelected()) {
            ...
            final int n2 = 0;
            AnimatingConstraints.setColorAnimation$default($this$invoke_u24lambda_u2d0, Animations.OUT_EXP, 0.5f, ExtensionsKt.toConstraint(VigilancePalette.INSTANCE.getTextHighlight$Vigilance()), 0.0f, 8, null);
