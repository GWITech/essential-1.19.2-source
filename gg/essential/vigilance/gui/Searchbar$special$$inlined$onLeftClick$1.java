...
public static final class Searchbar$special$$inlined$onLeftClick$1 extends Lambda implements Function2<UIComponent, UIClickEvent, Unit> {
    final /* synthetic */ Searchbar this$0;
    
    public Searchbar$special$$inlined$onLeftClick$1(final Searchbar this$0) {
        this.this$0 = this$0;
        super(2);
    }
    ...
    public final void invoke(@NotNull final UIComponent $this$onMouseClick, @NotNull final UIClickEvent it) {
        ...
        if (it.getMouseButton() == 0) {
            final UIComponent $this$toggleButton_delegate_u24lambda_u2d1 = $this$onMouseClick;
            final int n = 0;
            Searchbar.access$getCollapsed$p(this.this$0).set((Function1)Searchbar$toggleButton$3$1.INSTANCE);
            if (Searchbar.access$getCollapsed$p(this.this$0).get()) {
