...
public static final class DiscordIntegration$initialize$$inlined$onEvent$3 implements Flow<Object> {
    final /* synthetic */ Flow $this_unsafeTransform$inlined;
    
    public DiscordIntegration$initialize$$inlined$onEvent$3(final Flow $this_unsafeTransform$inlined) {
    ...
    public Object collect(@NotNull final FlowCollector collector, @NotNull final Continuation $completion) {
        ...
        final Object collect = this.$this_unsafeTransform$inlined.collect((FlowCollector)new SuspendFunction() {
            ...
            public DiscordIntegration$initialize$$inlined$onEvent$3$2() {
                super();
            }
            ...
            public final Object emit(final Object value, @NotNull final Continuation p1) {
                ...
                // Original Bytecode:
                // 
                //     1: instanceof      Lgg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1;
                //     4: ifeq            36
                //     7: aload_2        
                //     8: checkcast       Lgg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1;
                //    11: astore_3       
                //    12: aload_3        
                //    13: getfield        gg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1.label:I
                //    16: ldc             -2147483648
                //    18: iand           
                //    19: ifeq            36
                //    22: aload_3        
                //    23: dup            
                //    24: getfield        gg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1.label:I
                //    27: ldc             -2147483648
                //    29: isub           
                //    30: putfield        gg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1.label:I
                //    33: goto            46
                //    36: new             Lgg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1;
                //    39: dup            
                //    40: aload_0        
                //    41: aload_2        
                //    42: invokespecial   gg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1.<init>:(Lgg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2;Lkotlin/coroutines/Continuation;)V
                //    45: astore_3        /* $continuation */
                //    46: aload_3         /* $continuation */
                //    47: getfield        gg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1.result:Ljava/lang/Object;
                //    50: astore          $result
                ...
                //    58: getfield        gg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1.label:I
                //    61: tableswitch {
                //                0: 84
                //                1: 133
                //          default: 142
                ...
                //    89: aload_0         /* this */
                //    90: getfield        gg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2.$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
                //    93: aload_1         /* value */
                //    94: astore          6
                ...
                //   100: astore          it
                //   102: aload           it
                //   104: instanceof      Lgg/essential/lib/kdiscordipc/core/event/impl/ErrorEvent;
                //   107: ifeq            138
                ...
                //   116: iconst_1       
                //   117: putfield        gg/essential/handlers/discord/DiscordIntegration$initialize$$inlined$onEvent$3$2$1.label:I
