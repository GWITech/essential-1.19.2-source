...
static final class PauseMenuDisplay$init$bottomButton$2 extends Lambda implements Function1<UIConstraints, Unit> {
    public static final PauseMenuDisplay$init$bottomButton$2 INSTANCE;
    ...
    public final void invoke(@NotNull final UIConstraints $this$constrainTo) {
        ...
        $this$constrainTo.setY(new SiblingConstraint(64.0f, false, 2, null));
    ...
    static {
        PauseMenuDisplay$init$bottomButton$2.INSTANCE = new PauseMenuDisplay$init$bottomButton$2();
    }
}