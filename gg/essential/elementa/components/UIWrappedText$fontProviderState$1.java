...
static final class UIWrappedText$fontProviderState$1 extends Lambda implements Function1<UIConstraints, FontProvider> {
    public static final UIWrappedText$fontProviderState$1 INSTANCE;
    
    UIWrappedText$fontProviderState$1() {
        super(1);
    }
    ...
    static {
        UIWrappedText$fontProviderState$1.INSTANCE = new UIWrappedText$fontProviderState$1();
    }
}