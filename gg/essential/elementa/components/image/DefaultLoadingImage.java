...
public final class DefaultLoadingImage implements ImageProvider
{
    @NotNull
    public static final DefaultLoadingImage INSTANCE;
    @Nullable
    ...
    public void drawImage(@NotNull final UMatrixStack matrixStack, final double x, final double y, final double width, final double height, @NotNull final Color color) {
        ...
        if (DefaultLoadingImage.loadingTexture == null) {
            final BufferedImage loadingImage = DefaultLoadingImage.loadingImage;
            ...
            DefaultLoadingImage.loadingTexture = texture;
            DefaultLoadingImage.loadingImage = null;
        }
        ReleasedDynamicTexture loadingTexture;
        if ((loadingTexture = DefaultLoadingImage.loadingTexture) == null) {
    ...
    static {
        INSTANCE = new DefaultLoadingImage();
        DefaultLoadingImage.loadingImage = ImageIO.read(DefaultLoadingImage.INSTANCE.getClass().getResourceAsStream("/loading.png"));
    }
}
