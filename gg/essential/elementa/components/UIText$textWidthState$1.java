...
static final class UIText$textWidthState$1 extends Lambda implements Function1<Pair<? extends String, ? extends Pair<? extends Float, ? extends FontProvider>>, Float> {
    public static final UIText$textWidthState$1 INSTANCE;
    
    UIText$textWidthState$1() {
        super(1);
    }
    ...
    static {
        UIText$textWidthState$1.INSTANCE = new UIText$textWidthState$1();
    }
}