...
static final class UIWrappedText$verticallyCenteredState$1 extends Lambda implements Function1<UIConstraints, Boolean> {
    public static final UIWrappedText$verticallyCenteredState$1 INSTANCE;
    
    UIWrappedText$verticallyCenteredState$1() {
        super(1);
    }
    ...
    static {
        UIWrappedText$verticallyCenteredState$1.INSTANCE = new UIWrappedText$verticallyCenteredState$1();
    }
}