...
static final class UIWrappedText$textScaleState$1 extends Lambda implements Function1<UIConstraints, Float> {
    public static final UIWrappedText$textScaleState$1 INSTANCE;
    
    UIWrappedText$textScaleState$1() {
        super(1);
    }
    ...
    static {
        UIWrappedText$textScaleState$1.INSTANCE = new UIWrappedText$textScaleState$1();
    }
}