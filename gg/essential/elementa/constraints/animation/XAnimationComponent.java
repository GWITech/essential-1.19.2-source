...
public final class XAnimationComponent extends AnimationComponent<Float> implements XConstraint
{
    ...
    public XAnimationComponent(@NotNull final AnimationStrategy strategy, final int totalFrames, @NotNull final XConstraint oldConstraint, @NotNull final XConstraint newConstraint, final int delay) {
    ...
    @NotNull
    public final XConstraint getOldConstraint() {
        return this.oldConstraint;
    }
    
    @NotNull
    public final XConstraint getNewConstraint() {
    ...
    public float getXPositionImpl(@NotNull final UIComponent component) {
        ...
        final float startX = this.oldConstraint.getXPosition(component);
        final float finalX = this.newConstraint.getXPosition(component);
    ...
    @NotNull
    @Override
    public XAnimationComponent to(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        final XAnimationComponent $this$to_u24lambda_u2d0 = this;
        final int n = 0;
