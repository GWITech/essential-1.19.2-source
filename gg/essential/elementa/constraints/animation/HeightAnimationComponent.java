...
public final class HeightAnimationComponent extends AnimationComponent<Float> implements HeightConstraint
{
    ...
    public HeightAnimationComponent(@NotNull final AnimationStrategy strategy, final int totalFrames, @NotNull final HeightConstraint oldConstraint, @NotNull final HeightConstraint newConstraint, final int delay) {
    ...
    public float getHeightImpl(@NotNull final UIComponent component) {
        ...
        final float startX = this.oldConstraint.getHeight(component);
        final float finalX = this.newConstraint.getHeight(component);
        return startX + (finalX - startX) * this.getPercentComplete();
    }
    
    @Override
    public float getTextScale(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        ...
        if (this.getRecalculate()) {
            this.setCachedValue(this.getHeightImpl(component));
    ...
    @NotNull
    @Override
    public HeightAnimationComponent to(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        final HeightAnimationComponent $this$to_u24lambda_u2d0 = this;
        final int n = 0;
