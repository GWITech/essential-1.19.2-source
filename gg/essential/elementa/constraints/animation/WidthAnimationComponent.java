...
public final class WidthAnimationComponent extends AnimationComponent<Float> implements WidthConstraint
{
    ...
    public WidthAnimationComponent(@NotNull final AnimationStrategy strategy, final int totalFrames, @NotNull final WidthConstraint oldConstraint, @NotNull final WidthConstraint newConstraint, final int delay) {
    ...
    @NotNull
    public final WidthConstraint getOldConstraint() {
        return this.oldConstraint;
    }
    
    @NotNull
    public final WidthConstraint getNewConstraint() {
    ...
    public float getWidthImpl(@NotNull final UIComponent component) {
        ...
        final float startX = this.oldConstraint.getWidth(component);
        final float finalX = this.newConstraint.getWidth(component);
    ...
    @NotNull
    @Override
    public WidthAnimationComponent to(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        final WidthAnimationComponent $this$to_u24lambda_u2d0 = this;
        final int n = 0;
