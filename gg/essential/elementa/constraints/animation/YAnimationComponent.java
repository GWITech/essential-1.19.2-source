...
public final class YAnimationComponent extends AnimationComponent<Float> implements YConstraint
{
    ...
    public YAnimationComponent(@NotNull final AnimationStrategy strategy, final int totalFrames, @NotNull final YConstraint oldConstraint, @NotNull final YConstraint newConstraint, final int delay) {
    ...
    @NotNull
    public final YConstraint getOldConstraint() {
        return this.oldConstraint;
    }
    
    @NotNull
    public final YConstraint getNewConstraint() {
    ...
    public float getYPositionImpl(@NotNull final UIComponent component) {
        ...
        final float startX = this.oldConstraint.getYPosition(component);
        final float finalX = this.newConstraint.getYPosition(component);
    ...
    @NotNull
    @Override
    public YAnimationComponent to(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        final YAnimationComponent $this$to_u24lambda_u2d0 = this;
        final int n = 0;
