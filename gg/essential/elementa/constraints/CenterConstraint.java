...
public final class CenterConstraint implements PositionConstraint
{
    ...
    public float getXPositionImpl(@NotNull final UIComponent component) {
        ...
        return component.isPositionCenter() ? (parent.getLeft() + ExtensionsKt.roundToRealPixels(parent.getWidth() / 2)) : (parent.getLeft() + ExtensionsKt.roundToRealPixels(parent.getWidth() / 2 - component.getWidth() / 2));
    }
    ...
    public float getYPositionImpl(@NotNull final UIComponent component) {
        ...
        final UIComponent parent = uiComponent;
        return component.isPositionCenter() ? (parent.getTop() + ExtensionsKt.roundToRealPixels(parent.getHeight() / 2)) : (parent.getTop() + ExtensionsKt.roundToRealPixels(parent.getHeight() / 2 - component.getHeight() / 2));
    }
    ...
    public void visitImpl(@NotNull final ConstraintVisitor visitor, @NotNull final ConstraintType type) {
        ...
        switch (CenterConstraint.WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
            case 1: {
