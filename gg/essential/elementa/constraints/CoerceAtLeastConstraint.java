...
public final class CoerceAtLeastConstraint implements MasterConstraint
{
    ...
    public CoerceAtLeastConstraint(@NotNull final SuperConstraint<Float> constraint, @NotNull final SuperConstraint<Float> minConstraint) {
    ...
    public float getWidthImpl(@NotNull final UIComponent component) {
        ...
        return RangesKt.coerceAtLeast(((WidthConstraint)this.constraint).getWidth(component), ((WidthConstraint)this.minConstraint).getWidth(component));
    }
    
    @Override
    public float getHeightImpl(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        return RangesKt.coerceAtLeast(((HeightConstraint)this.constraint).getHeight(component), ((HeightConstraint)this.minConstraint).getHeight(component));
    }
    
    @Override
    public float getRadiusImpl(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        return RangesKt.coerceAtLeast(((RadiusConstraint)this.constraint).getRadius(component), ((RadiusConstraint)this.minConstraint).getRadius(component));
    }
    
    @Override
    public float getXPositionImpl(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        return RangesKt.coerceAtLeast(((XConstraint)this.constraint).getXPosition(component), ((XConstraint)this.minConstraint).getXPosition(component));
    }
    
    @Override
    public float getYPositionImpl(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        return RangesKt.coerceAtLeast(((YConstraint)this.constraint).getYPosition(component), ((YConstraint)this.minConstraint).getYPosition(component));
    }
    
    @NotNull
    @Override
    public CoerceAtLeastConstraint to(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        final CoerceAtLeastConstraint $this$to_u24lambda_u2d0 = this;
        final int n = 0;
