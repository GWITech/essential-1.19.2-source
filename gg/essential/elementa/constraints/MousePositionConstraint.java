...
public final class MousePositionConstraint implements PositionConstraint
{
    ...
    public MousePositionConstraint() {
        super();
    ...
    public float getXPositionImpl(@NotNull final UIComponent component) {
        ...
        return UIComponent.Companion.getMouseX$Elementa();
    }
    
    @Override
    public float getYPositionImpl(@NotNull final UIComponent component) {
        Intrinsics.checkNotNullParameter((Object)component, "component");
        return UIComponent.Companion.getMouseY$Elementa();
    }
