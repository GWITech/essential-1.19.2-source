...
public final class $Gson$Types
{
    ...
    public static WildcardType subtypeOf(final Type bound) {
        ...
        return (WildcardType)new $Gson$Types.WildcardTypeImpl(upperBounds, $Gson$Types.EMPTY_TYPE_ARRAY);
    }
    ...
    public static WildcardType supertypeOf(final Type bound) {
        ...
        return (WildcardType)new $Gson$Types.WildcardTypeImpl(new Type[] { Object.class }, lowerBounds);
    }
    ...
    public static Type canonicalize(final Type type) {
        ...
        if (type instanceof WildcardType) {
            ...
            return (Type)new $Gson$Types.WildcardTypeImpl(w.getUpperBounds(), w.getLowerBounds());
        }
        return type;
    }
