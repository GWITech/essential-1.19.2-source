...
class SSLA<K, V> extends SSL<K, V>
{
    ...
    SSLA(final Caffeine<K, V> builder, final CacheLoader<? super K, V> cacheLoader, final boolean async) {
        ...
        this.writeBuffer = new MpscGrowableArrayQueue<Runnable>(4, SSLA.WRITE_BUFFER_MAX);
