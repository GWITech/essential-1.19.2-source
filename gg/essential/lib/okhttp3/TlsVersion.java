...
public enum TlsVersion
{
    ...
    public static TlsVersion valueOf(final String name) {
        return Enum.valueOf(TlsVersion.class, name);
    }
    ...
    static {
        $VALUES = new TlsVersion[] { TlsVersion.TLS_1_3, TlsVersion.TLS_1_2, TlsVersion.TLS_1_1, TlsVersion.TLS_1_0, TlsVersion.SSL_3_0 };
    }
}
