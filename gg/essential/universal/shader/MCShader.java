...
@Metadata(mv = { 1, 6, 0 }, k = 1, xi = 48, d1 = { """
                                                   ...
                                                   \u0002\b\u0006
                                                   \u0002\u0018\u0002
                                                   \u0002\b\u0004\b\u0000\u0018\u0000 \u001c2\u00020\u0001:\u0001\u001cB\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\b\u0010\r\u001a\u00020\u000eH\u0016J\u0012\u0010\u000f\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u0012\u0010\u0013\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u0012\u0010\u0014\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u0012\u0010\u0015\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u0012\u0010\u0016\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u0012\u0010\u0017\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u0010\u0010\u0018\u001a\u00020\u00192\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u0012\u0010\u001a\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0011\u001a\u00020\u0012H\u0002J\b\u0010\u001b\u001a\u00020\u000eH\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002
                                                   \u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002
                                                   \u0000R\u001a\u0010\u0007\u001a\u00020\bX\u0096\u000e¢\u0006\u000e
                                                   \u0000\u001a\u0004\b	\u0010
                                                   "\u0004\b\u000b\u0010\f¨\u0006\u001d""" }, d2 = { "Lgg/essential/universal/shader/MCShader;", "Lgg/essential/universal/shader/UShader;", "mc", "Lnet/minecraft/client/render/Shader;", "blendState", "Lgg/essential/universal/shader/BlendState;", "(Lnet/minecraft/client/render/Shader;Lgg/essential/universal/shader/BlendState;)V", "usable", "", "getUsable", "()Z", "setUsable", "(Z)V", "bind", "", "getFloat2UniformOrNull", "Lgg/essential/universal/shader/MCShaderUniform;", "name", "", "getFloat3UniformOrNull", "getFloat4UniformOrNull", "getFloatMatrixUniformOrNull", "getFloatUniformOrNull", "getIntUniformOrNull", "getSamplerUniformOrNull", "Lgg/essential/universal/shader/MCSamplerUniform;", "getUniformOrNull", "unbind", "Companion", "universalcraft" })
public final class MCShader implements UShader
{
    ...
    private static final boolean DEBUG_LEGACY;
    
    public MCShader(@NotNull final Shader mc, @NotNull final BlendState blendState) {
    ...
    public void setUsable(final boolean <set-?>) {
        this.usable = <set-?>;
    }
    
    @Override
    public void bind() {
        UGraphics.setShader(MCShader::bind$lambda-0);
    ...
    private final MCShaderUniform getUniformOrNull(final String name) {
        final GlUniform uniform = this.mc.getUniform(name);
        MCShaderUniform mcShaderUniform;
        if (uniform == null) {
            mcShaderUniform = null;
        }
        else {
            final GlUniform p0 = uniform;
            final int n = 0;
            mcShaderUniform = new MCShaderUniform(p0);
        }
        return mcShaderUniform;
    }
    
    @Nullable
    @Override
    public MCShaderUniform getIntUniformOrNull(@NotNull final String name) {
        Intrinsics.checkNotNullParameter((Object)name, "name");
        return this.getUniformOrNull(name);
    }
    
    @Nullable
    @Override
    public MCShaderUniform getFloatUniformOrNull(@NotNull final String name) {
        Intrinsics.checkNotNullParameter((Object)name, "name");
        return this.getUniformOrNull(name);
    }
    ...
    @Nullable
    @Override
    public MCShaderUniform getFloat2UniformOrNull(@NotNull final String name) {
        Intrinsics.checkNotNullParameter((Object)name, "name");
        return this.getUniformOrNull(name);
    }
    ...
    @Nullable
    @Override
    public MCShaderUniform getFloat3UniformOrNull(@NotNull final String name) {
        Intrinsics.checkNotNullParameter((Object)name, "name");
        return this.getUniformOrNull(name);
    }
    ...
    @Nullable
    @Override
    public MCShaderUniform getFloat4UniformOrNull(@NotNull final String name) {
        Intrinsics.checkNotNullParameter((Object)name, "name");
        return this.getUniformOrNull(name);
    }
    ...
    @Nullable
    @Override
    public MCShaderUniform getFloatMatrixUniformOrNull(@NotNull final String name) {
        Intrinsics.checkNotNullParameter((Object)name, "name");
        return this.getUniformOrNull(name);
    }
    ...
    @NotNull
    @Override
    public MCSamplerUniform getSamplerUniformOrNull(@NotNull final String name) {
        Intrinsics.checkNotNullParameter((Object)name, "name");
        return new MCSamplerUniform(this.mc, name);
    }
    
    private static final Shader bind$lambda-0(final KProperty0 $tmp0) {
        Intrinsics.checkNotNullParameter((Object)$tmp0, "$tmp0");
        return (Shader)((Function0)$tmp0).invoke();
    }
    
    private static final Shader unbind$lambda-1() {
        return null;
    }
    
    @Override
    public /* bridge */ IntUniform getIntUniformOrNull(final String name) {
        return this.getIntUniformOrNull(name);
    }
    
    @Override
    public /* bridge */ FloatUniform getFloatUniformOrNull(final String name) {
        return this.getFloatUniformOrNull(name);
    }
    
    @Override
    public /* bridge */ Float2Uniform getFloat2UniformOrNull(final String name) {
        return this.getFloat2UniformOrNull(name);
    }
    
    @Override
    public /* bridge */ Float3Uniform getFloat3UniformOrNull(final String name) {
        return this.getFloat3UniformOrNull(name);
    }
    
    @Override
    public /* bridge */ Float4Uniform getFloat4UniformOrNull(final String name) {
        return this.getFloat4UniformOrNull(name);
    }
    
    @Override
    public /* bridge */ FloatMatrixUniform getFloatMatrixUniformOrNull(final String name) {
        return this.getFloatMatrixUniformOrNull(name);
    }
    
    @Override
    public /* bridge */ SamplerUniform getSamplerUniformOrNull(final String name) {
        return this.getSamplerUniformOrNull(name);
    }
    
    public static final /* synthetic */ Shader access$getMc$p(final MCShader $this) {
        return $this.mc;
    }
    
    public static final /* synthetic */ boolean access$getDEBUG_LEGACY$cp() {
        return MCShader.DEBUG_LEGACY;
    }
    
    static {
        Companion = new Companion(null);
        DEBUG_LEGACY = Intrinsics.areEqual((Object)System.getProperty("universalcraft.shader.legacy.debug", ""), (Object)"true");
    }
